...
export async function GET() {
  try {
    ...
    return new Response(`<?xml version="1.0" encoding="UTF-8"?>\n<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">\n<channel><title>长岛冰茶的个人博客</title><link>${host}</link><description>分享技术见解、学习心得和开发经验</description><language>zh-CN</language><atom:link href="${host}/rss.xml" rel="self" type="application/rss+xml"/>\n${items}\n</channel>\n</rss>`, { headers: { 'Content-Type': 'application/xml; charset=utf-8' } })
