...
import { Plus, Pencil, Trash2, ExternalLink, Search, Save, LogOut, FileText, Edit } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950/20 to-slate-950">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          >
            ...
            <p className="text-slate-400">
              {isEditMode ? '管理模式：可以新增、编辑和删除博客' : '浏览模式：仅查看博客列表（点击右下角"管理"按钮进入管理模式）'}
            </p>
            {!isEditMode && (
              <motion.div
                initial={{ opacity: 0 }}
              ...
              >
                💡 提示：点击右下角的"管理"按钮，输入密码（admin123）即可编辑博客
              </motion.div>
            )}
          </motion.div>
        </div>
        ...
        {/* Add Blog Button - Only visible in edit mode */}
        <AnimatePresence>
          {isEditMode && (
            <motion.button
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="前端, JavaScript, React"
                    className="bg-slate-800 border-slate-700 text-white placeholder:text-slate-500"
                  />
                </div>
                <div>
