...
export const SEED_PROJECTS = [
  // === 开发中 ===
  {
    id: 1, title: '新叶日报', status: 'developing',
  ...
  // === 验证中 ===
  {
    id: 2, title: 'opencolorful', status: 'validating',
  ...
  {
    id: 3, title: 'body', status: 'validating',
  ...
  // === 维护中 ===
  {
    id: 4, title: '个人博客', status: 'maintaining',
  ...
  // === 已完成 ===
  {
    id: 5, title: '四季清单 - TaskFlow', status: 'completed',
  ...
  // === 已废弃 ===
  {
    id: 6, title: 'NovaWrite', status: 'abandoned',
    description: '基于多 Agent 协作的 AI 长篇小说创作系统。',
  ...
  {
    id: 7, title: 'Live2D 看板娘「橙」', status: 'abandoned',
    description: '基于 Live2D 的桌面看板娘演示项目。',
  ...
  {
    id: 8, title: '龙虾工作台', status: 'abandoned',
  ...
  {
    id: 9, title: '四季清单智能助手', status: 'abandoned',
    description: 'TaskFlow 的 Python Agent 后端。',
  ...
  {
    id: 10, title: 'AI Pulse（旧版）', status: 'abandoned',
    description: '新叶日报的前身，功能和代码已融入新叶日报。',
    techStack: 'Next.js, TypeScript, Supabase',
    imageUrl: null, githubUrl: 'https://github.com/czj527/aiweb', demoUrl: null, order: 10,
    createdAt: '2026-05-27T00:00:00.000Z', updatedAt: '2026-05-27T00:00:00.000Z',
  },
  {
    id: 11, title: '新叶AI（旧版）', status: 'abandoned',
    description: 'AI 资讯网站早期版本，新叶日报的孵化项目。',
  ...
  {
    id: 12, title: '疆韵易购 - 团购电商平台', status: 'abandoned',
    description: '面向新疆特色产品的团购电商平台（武汉工程大学课程设计）。',
  ...
  {
    id: 13, title: '问卷自动填写脚本', status: 'abandoned',
    description: '基于 TypeScript + Puppeteer 的自动化工具。',
